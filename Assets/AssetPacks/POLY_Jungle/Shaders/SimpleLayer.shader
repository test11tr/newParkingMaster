...
Shader "BK/SimpleLayer"
{
	Properties
	{
		...
		[ASEBegin]_Color("Main Color", Color) = (1,1,1,1)
		...
		[ASEEnd]_Metallic1("Layer Metalness", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float clampResult21 = clamp( (WorldNormal.y*1.0 + _LayerOffset) , 0.001 , 1.0 );
				...
				float3 Albedo = ( lerpResult6 * tex2D( _MainTex, uv_MainTex ) ).rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = lerpResult29;
...
/*ASEBEGIN
Version=18912
934;79.33334;957.3334;876.3333;105.3282;485.4298;1;True;False
...
WireConnection;36;3;29;0
WireConnection;36;4;28;0
ASEEND*/
//CHKSM=675D04CDA11B79E6762E913F3CE0539EA9935939